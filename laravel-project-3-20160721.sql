...
INSERT INTO `members` (`id`, `user_id`, `name`, `gender`, `avatar`, `authable`, `status`, `passport_front_images`, `passport_back_images`, `passport_handheld_id_images`, `created_at`, `updated_at`) VALUES
	(1, 3, '张小星家长', 1, NULL, 0, 1, '', '', '', '2016-07-20 10:41:54', '0000-00-00 00:00:00');
...
INSERT INTO `organizations` (`id`, `user_id`, `name`, `gender`, `authable`, `status`, `corporate_id_images`, `business license_images`, `created_at`, `updated_at`) VALUES
...
-- 正在导出表  laravel-project-3.permissions 的数据：~26 rows (大约)
...
-- 正在导出表  laravel-project-3.permission_role 的数据：~32 rows (大约)
...
INSERT INTO `personals` (`id`, `user_id`, `name`, `description`, `gender`, `avatar`, `authable`, `status`, `passport_front_images`, `passport_back_images`, `passport_handheld_id_images`, `created_at`, `updated_at`) VALUES
	(3, 1, '张老师', '个人金牌家教', 1, '', 0, 0, '', '', '', '2016-07-20 10:36:07', '0000-00-00 00:00:00');
...
-- 正在导出表  laravel-project-3.tag_user 的数据：~1 rows (大约)
...
INSERT INTO `users` (`id`, `name`, `email`, `type`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'test1', 'test1@admin.com', 3, '$2y$10$osDZZ10QibYuAmyQm4i0.OYMWn268cW/0rrxgcqi.e6HRU3gQvaDy', 'XNVvrMBuYwc6RY6dibjLJH9QjhNDk7eTzmZDv1RAP7kPEeHeefzVfgh5eeLZ', '2016-07-21 13:55:46', '2016-07-21 02:18:59'),
	(2, 'test2', 'test2@admin.com', 2, '$2y$10$2ATviDVWAvaFMDXdaYuYke.RkP.tOGCjf2I0Sy0KIpEQCwUX3CG.2', '4jpLX88OcEKp22AngaCaU0DxMYycOk16sowFpOQbTQFu81CsHbhb8nI5Xxbn', '2016-07-20 10:41:29', '2016-07-20 02:41:29'),
	(3, 'test3', 'test3@admin.com', 1, '$2y$10$C3oxZDRr4l5ykMdBKfewGu26tsG5Q/bBxmZ9DMIJFmtUDF8UaOpCi', 'XepCAhqwZLLcVx589939LulrCAq4gzJVjCmVgoJh6BRTTGpwrf4brVpO5XiW', '2016-07-21 13:55:45', '2016-07-19 01:51:32');
